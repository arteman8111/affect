...
$headerConf = "Ремонт генераторов";
$priceText = "генератора";
$link = "remont-generatorov"
?>
<!DOCTYPE html>
...
<body class="wrapper">
  ...
  <main>
    ...
    <div class="container price-box">
      <div class="row">
      <table class="price-table"><thead><tr><th>Услуга</th><th>Цена</th><th>Услуга</th><th>Цена</th></tr></thead><tbody><tr><td>ТО</td><td>от 2000</td><td>Чистка регулировка карбюратора с разборкой</td><td>от 600</td></tr><tr><td>Прокачка дискового тормоза (с заменой тормоз.жидкости)</td><td>500</td><td>Замена впускного коллектора</td><td>от 400</td></tr><tr><td>Ремонт головки цилиндров (с регулировкой клапанов)</td><td>от 1500</td><td>Замена шестерней редуктора</td><td>от 1200</td></tr><tr><td>Замена шестеренок кик стартера</td><td>от 400</td><td>Замена троса газа</td><td>от 500</td></tr><tr><td>Замена передних амортизаторов</td><td>от 600</td><td>Замена сайлентблоков двигателя</td><td>от 1000</td></tr><tr><td>Замена подшипников редуктора</td><td>от 1200</td><td>Установка сигнализации</td><td>от 1000</td></tr><tr><td>Ремонт электро стартера</td><td>от 500</td><td>Замена ремня вариатора</td><td>от 400</td></tr></tbody></table>  
    </div>
    </div>
  </main>
