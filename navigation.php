...
<body class="wrapper">
    ...
    <main>
        <div class="container">
            <div class="nav">
                <h3 style="cursor:default">Ремонт бытовой техники</h3>
                <ul>
                    <?php
                ...
                <h3 style="cursor:default">Ремонт компьютерной техники</h3>
                <ul>
                    <?php
                ...
                <h3 style="cursor:default">Ремонт бензиновой техники</h3>
                <ul>
                    <?php
